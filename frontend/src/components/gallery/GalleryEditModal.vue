          ...
          <div class="bg-background px-6 py-4">
            <div class="space-y-6">
              ...
              <div>
                ...
                <div class="w-full h-48 bg-muted rounded-lg overflow-hidden">
                  <img
                    :src="image.url"
                    :alt="image.title"
...
watch(() => props.image, (newImage) => {
  if (newImage) {
    ...
    form.is_featured = newImage.is_featured || false
...
const handleSubmit = async () => {
  try {
    ...
    const updatedImage = {
      ...
      url: form.newImage || props.image.url, // Use new image if provided
