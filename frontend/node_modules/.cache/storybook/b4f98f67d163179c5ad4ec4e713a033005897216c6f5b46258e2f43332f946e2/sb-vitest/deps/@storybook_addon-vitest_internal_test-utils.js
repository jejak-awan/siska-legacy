...
var setViewport = async (parameters = {}, globals = {}) => {
  ...
  let viewports = { ...n, ...viewportsParam.viewports, ...viewportsParam.options }, viewportWidth = DEFAULT_VIEWPORT_DIMENSIONS.width, viewportHeight = DEFAULT_VIEWPORT_DIMENSIONS.height;
...
var testStory = (exportName, story, meta, skipTags) => async (context) => {
  let annotations = Yr(story, meta), composedStory = Ro(annotations.story, annotations.meta, { initialGlobals: await (getInitialGlobals == null ? void 0 : getInitialGlobals()) ?? {} }, annotations.preview ?? globalThis.globalProjectAnnotations, exportName);
