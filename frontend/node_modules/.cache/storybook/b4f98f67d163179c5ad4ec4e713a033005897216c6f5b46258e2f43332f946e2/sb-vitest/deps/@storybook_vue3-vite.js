...
import "./chunk-MNQ7A5KO.js";
import "./chunk-FFTSRKFC.js";
import {
  scope
...
import {
  ...
  isVNode,
  reactive
} from "./chunk-NGLHW3YE.js";
import "./chunk-256EKJAK.js";

// node_modules/@storybook/vue3/dist/chunk-CEH6MNVV.mjs
...
var extractFromVueDocgenApi = (docgenInfo, section, extractedProp) => {
  ...
  if (section === "props") {
    ...
    if (type = (_c = propInfo.type) == null ? void 0 : _c.name, sbType = extractedProp ? pe(extractedProp.docgenInfo) : { name: "other", value: type }, propInfo.type && "elements" in propInfo.type && Array.isArray(propInfo.type.elements) && propInfo.type.elements.length > 0) {
...
function setProjectAnnotations(projectAnnotations) {
  return Ws(vueProjectAnnotations), Xs(projectAnnotations);
}
var vueProjectAnnotations = { ...entry_preview_exports, renderToCanvas: (renderContext, canvasElement) => {
  ...
  let { storyFn, storyContext: { testingLibraryRender: render2 } } = renderContext, { unmount } = render2(storyFn(), { container: canvasElement });
  return unmount;
} };
function composeStory(story, componentAnnotations, projectAnnotations, exportsName) {
  let composedStory = Ro(story, componentAnnotations, projectAnnotations, globalThis.globalProjectAnnotations ?? vueProjectAnnotations, exportsName), renderable = (...args) => h(composedStory(...args));
  return Object.assign(renderable, composedStory), renderable;
}
function composeStories(csfExports, projectAnnotations) {
  return Qs(csfExports, projectAnnotations, composeStory);
}
export {
  composeStories,
  composeStory,
